        ...
        <HomeLayout>
            <div className="flex items-center justify-center h-[100vh]">
                ...
                >
                    ...
                    <button type="submit" className="w-full bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300 rounded-sm font-semibold py-2 cursor-pointer text-lg">Update Profile</button>
